...
interface IVaultFactory is IOwnable {
    ...
    /// @notice Sets the address of the Entry point creator contract.
    /// @dev This function can only be called by an authorized admin.
    /// @param _entryPointCreator The address of the Entry point creator contract.
    function setEntryPointCreatorAddress(address _entryPointCreator) external;
