...
contract AccessControlLogic is IAccessControlLogic, BaseContract {
    ...
    /// @notice If this smart-contract is an owner of other contract - this contract must implement ERC1271 method.
    ...
    function isValidSignature(
        ...
        return
            AccessControlLib.isValidSignature(dataHash, signature)
