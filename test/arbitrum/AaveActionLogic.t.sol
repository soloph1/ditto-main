...
contract AaveActionLogicTest is Test, FullDeploy {
    ...
    address donor = 0x3e0199792Ce69DC29A0a36146bFa68bd7C8D6633;
    ...
    function test_arb_aaveActionLogic_supplyAaveAction() external {
        multicallData.push(
            abi.encodeCall(
    ...
    function test_arb_aaveActionLogic_supplyAaveAction_transferFromRevert()
        external
    {
        multicallData.push(
            abi.encodeCall(
    ...
    function test_arb_aaveActionLogic_borrowAaveAction() external {
        multicallData.push(
            abi.encodeCall(
                IAaveActionLogic.supplyAaveAction,
                (wethAddress, 1 ether)
    ...
    function test_arb_aaveActionLogic_cannotBorrowMoreThanSupply() external {
        multicallData.push(
            abi.encodeCall(
                IAaveActionLogic.supplyAaveAction,
                (wethAddress, 1 ether)
    ...
    function test_arb_aaveActionLogic_repayAave() external {
        multicallData.push(
            abi.encodeCall(
                IAaveActionLogic.supplyAaveAction,
                (wethAddress, 1 ether)
    ...
    function test_arb_aaveActionLogic_repayAave_transferFromRevert() external {
        multicallData.push(
            abi.encodeCall(
                IAaveActionLogic.supplyAaveAction,
                (wethAddress, 1 ether)
    ...
    function test_arb_aaveActionLogic_withdrawAave() external {
        multicallData.push(
            abi.encodeCall(
                IAaveActionLogic.supplyAaveAction,
                (wethAddress, 1 ether)
    ...
    function test_arb_aaveActionLogic_revertIfWithdrawMoreThanTotal() external {
        multicallData.push(
            abi.encodeCall(
                IAaveActionLogic.supplyAaveAction,
                (wethAddress, 1 ether)
    ...
    function test_arb_aaveActionLogic_cannotWithdrawAllIfDebtExists() external {
        multicallData.push(
            abi.encodeCall(
                IAaveActionLogic.supplyAaveAction,
                (wethAddress, 1 ether)
    ...
    function test_arb_aaveActionLogic_emergencyRepayAave() external {
        multicallData.push(
            abi.encodeCall(
                IAaveActionLogic.supplyAaveAction,
                (wethAddress, 1 ether)
    ...
    function test_arb_aaveActionLogic_accessControl() external {
        vm.prank(vaultOwner);
        vm.expectRevert(
