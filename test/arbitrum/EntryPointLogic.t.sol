...
import {ArbGasInfoMock} from "./mocks/ArbGasInfoMock.sol";
...
contract TestEntryPointLogic is Test, FullDeploy {
    ...
    function setUp() external {
        ...
        ArbGasInfoMock gasInfo = new ArbGasInfoMock();
        vm.etch(
            0x000000000000000000000000000000000000006C,
            address(gasInfo).code
        );
    ...
    function test_arb_entryPointLogic_addWorkflow_shouldUpdateState() external {
        (
    ...
    function test_arb_entryPointLogic_addWorkflow_shouldExecuteInitCalls()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_addWorkflow_shouldRevertInInitCall()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_addWorkflow_shouldGrantRole() external {
        (
            IEntryPointLogic.Checker[] memory checkers,
            IEntryPointLogic.Action[] memory actions
        ) = _checkersAndActionsWithTimeAndPriceCheckers();
    ...
    function test_arb_entryPointLogic_addWorkflow_accessControl() external {
        (
            IEntryPointLogic.Checker[] memory checkers,
            IEntryPointLogic.Action[] memory actions
        ) = _checkersAndActionsWithTimeAndPriceCheckers();
    ...
    function test_arb_entryPointLogic_run_successfulRunUniswap() external {
        (
            IEntryPointLogic.Checker[] memory checkers,
            IEntryPointLogic.Action[] memory actions
        ) = _checkersAndActionsWithTimeAndPriceCheckers();
    ...
    function test_arb_entryPointLogic_run_successfulRunDeltaNeutralRebalance()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_run_unsuccessfulRun() external {
        (
            IEntryPointLogic.Checker[] memory checkers,
            IEntryPointLogic.Action[] memory actions
        ) = _checkersAndActionsWithTimeAndPriceCheckers();
    ...
    function test_arb_entryPointLogic_run_shouldRevertWithRevertedAction()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_run_shouldSendDittoFeeToDittoTreasury()
        external
    {
    ...
    function test_arb_entryPointLogic_run_shouldRevertIfFeeDoesNotEnough()
        external
    {
        address treasury = makeAddr("treasury");
        vm.prank(vaultOwner);
    ...
    function test_arb_entryPointLogic_run_shouldRevertIfWorkflowDoesNotExists()
        external
    {
        vm.prank(vaultOwner);
        vm.expectRevert(
    ...
    function test_arb_entryPointLogic_run_singleExecute() external {
        (
            IEntryPointLogic.Checker[] memory checkers,
            IEntryPointLogic.Action[] memory actions
        ) = _checkersAndActionsWithTimeChecker();
    ...
    function test_arb_entryPointLogic_run_executeFiveTimes() external {
        (
            IEntryPointLogic.Checker[] memory checkers,
            IEntryPointLogic.Action[] memory actions
        ) = _checkersAndActionsWithTimeChecker();
    ...
    function test_arb_entryPointLogic_createTask_shouldCreateTaskForWorkflow()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_createTask_cannotCreateSeveralTaskForOneWorkflow()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_createTask_shouldRevertIfWorkflowDoesNotExists()
        external
    {
        vm.prank(vaultOwner);
        vm.expectRevert(
    ...
    function test_arb_entryPointLogic_createTask_accessControl() external {
        vm.prank(vaultOwner);
        vm.expectRevert(
            abi.encodeWithSelector(
                BaseContract.UnauthorizedAccount.selector,
    ...
    function test_arb_entryPointLogic_cancelTask_shouldCancelTaskForWorkflow()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_cancelTask_cannotCancelTaskWhichNotExists()
        external
    {
        vm.prank(vaultOwner);
        vm.expectRevert(
    ...
    function test_arb_entryPointLogic_cancelTask_accessControl() external {
        (
            IEntryPointLogic.Checker[] memory checkers,
            IEntryPointLogic.Action[] memory actions
        ) = _checkersAndActionsWithTimeChecker();
    ...
    function test_arb_entryPointLogic_runGelato_successfulRunGelato() external {
        (
            IEntryPointLogic.Checker[] memory checkers,
            IEntryPointLogic.Action[] memory actions
        ) = _checkersAndActionsWithTimeAndPriceCheckers();
    ...
    function test_arb_entryPointLogic_runGelato_shouldSendDittoFee() external {
        address treasury = makeAddr("treasury");
    ...
    function test_arb_entryPointLogic_runGelato_successfulRunGelatoAndCancelTaskIfCounterIsZero()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_runGelato_onlyDedicatedMsgSenderRevert()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_runGelato_shouldRevertIfGelatoFeeNotEnough()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_runGelato_shouldRevertIfWorkflowDoesNotExists()
        external
    {
    ...
    function test_arb_entryPointLogic_deactivateVault_shouldStopAllWorkflows()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_deactivateVault_shouldRevertIfVaultAlreadyDeactivated()
        external
    {
        vm.startPrank(vaultOwner);
    ...
    function test_arb_entryPointLogic_deactivateVault_shouldExecuteCallbacks()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_deactivateVault_accessControl() external {
        bytes[] memory callbacks;
    ...
    function test_arb_entryPointLogic_activateVault_shouldRunAllWorkflows()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_activateVault_shouldRevertIfVaultAlreadyActivated()
        external
    {
        bytes[] memory callbacks;
    ...
    function test_arb_entryPointLogic_activateVault_shouldExecuteCallbacks()
        external
    {
        bytes[] memory callbacks;
        vm.prank(vaultOwner);
    ...
    function test_arb_entryPointLogic_activateVault_accessControl() external {
        bytes[] memory callbacks;
    ...
    function test_arb_entryPointLogic_deactivateWorkflow_shouldStopWorkflow()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_deactivateWorkflow_shouldRevertIfWorkflowAlreadyDeactivated()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_deactivateWorkflow_accessControl()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_deactivateWorkflow_shouldRevertIfWorkflowDoesNotExists()
        external
    {
        vm.prank(vaultOwner);
        vm.expectRevert(
    ...
    function test_arb_entryPointLogic_activateWorkflow_shouldRunWorkflow()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_activateWorkflow_shouldRevertIfWorkflowAlreadyActivated()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_activateWorkflow_accessControl()
        external
    {
        (
            IEntryPointLogic.Checker[] memory checkers,
    ...
    function test_arb_entryPointLogic_activateWorkflow_shouldRevertIfWorkflowDoesNotExists()
        external
    {
        vm.prank(vaultOwner);
        vm.expectRevert(
